import { Component,DoCheck, Input, OnInit,OnDestroy, SimpleChange, ChangeDetectorRef, ChangeDetectionStrategy, AfterContentChecked, AfterViewInit } from '@angular/core';
...
// Metodo  che filtra la tabella
 ...
 onDetail():void{
  ...
  addUtente(){
    this.servicedDbService.form1$.pipe(switchMap(res => this.servicedDbService.addUtente(res)))
    .subscribe(h=> {
          this.utenti.push(h);
       });
       this.getUtenti();
